          ...
          <div className="space-y-3">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex items-center gap-3 p-3">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-slate-200 to-slate-300 animate-pulse" />
            ...
            return (
              <div
                ...
                className={`group relative p-3 rounded-2xl cursor-pointer transition-all duration-300 ${
                  isActive
                    ? "bg-gradient-to-r from-blue-500/10 to-indigo-500/10 shadow-[inset_2px_2px_6px_rgba(0,0,0,0.04),inset_-2px_-2px_6px_rgba(255,255,255,0.8)]"
                    : "hover:bg-white/60"
                }`}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <h3 className={`font-semibold truncate text-sm ${isActive ? "text-blue-700" : "text-slate-700"}`}>
                        {chatName}
                      </h3>
                      {chat.last_message && (
